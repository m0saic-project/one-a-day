...
// session pushes it after reading the gate's verdict. (day-004's runner, via day-006's,
// re-dated.)
...
say(`=== one-a-day · ${DATE} · day 7 · agent claude (claude-opus-5-5) · interactive session, gate only${NO_PUSH ? " · no push" : ""} ===`);
