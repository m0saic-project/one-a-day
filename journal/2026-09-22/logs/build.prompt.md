# one-a-day — 2026-09-22 — phase: build
...
Build today's template from `journal/2026-09-22/20-brief.md`. This phase may be
called more than once; `journal/2026-09-22/30-build.md` and `state.json` tell you
where you left off.
...
5. Render and snapshot the variant:
   `node pipeline/render/render-variant.mjs @one-a-day/<pack>/<slug>/v1 journal/2026-09-22/variants/a`
...
## Output — `journal/2026-09-22/30-build.md`
