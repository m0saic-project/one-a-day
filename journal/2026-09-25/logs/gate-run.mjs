...
// session pushes it after reading the gate's verdict. (day-004's runner,
// re-dated.)
...
say(`=== one-a-day · ${DATE} · day 6 · agent claude (claude-fable-5) · interactive session, gate only${NO_PUSH ? " · no push" : ""} ===`);
