...
const report = fs.existsSync(REPORT)
  ...
  : { templateId, at: new Date().toISOString(), props: PROPS ?? null, build: null, kind: null, renders: [], stills: [], srcSnapshot: null, ok: true, degraded: false, split: { runner: "journal/2026-09-25/logs/render-variant-split.mjs", steps: [] } };
