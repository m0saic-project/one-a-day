...
async function render(props: BenchDeltaProps, ctx: MosaicEngineContext): Promise<MosaicDocument> {
  ...
  L.rows.forEach((r, i) => {
    ...
    // does not get one: "no spread given" stays quiet dim type with nothing
    // behind it. Drawing it as a filled pill was variant b, and it read as a
    // fourth verdict rather than the absence of one.
